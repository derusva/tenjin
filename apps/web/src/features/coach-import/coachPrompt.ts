...
export const COACH_TRANSFER_REPAIR_PROMPT = [
  ...
  "items 必须是包含 0-3 条的数组。每条只能有 type、focus、sourceExcerpt、answer，以及可选的 transferSentence。",
  "type 固定为 lookup；focus、sourceExcerpt、answer 和存在时的 transferSentence 都必须是非空字符串。",
